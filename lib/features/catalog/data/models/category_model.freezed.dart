...
mixin _$CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, priority: $priority)';
  }
}
...
abstract mixin class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, num priority});
}
...
extension CategoryModelPatterns on CategoryModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, num priority)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CategoryModel() when $default != null:
        return $default(_that.id, _that.name, _that.priority);
      case _:
        return orElse();
    }
  }
...
class _CategoryModel extends CategoryModel {
  const _CategoryModel(
      {required this.id, required this.name, required this.priority})
      : super._();
